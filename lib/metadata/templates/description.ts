...
const DEFAULT_TEMPLATE = 'InsoScope is a lightweight, open-source explorer for the INSO Awesome chain. Browse transactions, verify smart contracts, analyze activity, and interact with the Flatgas protocol.';
